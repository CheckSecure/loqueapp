...
export default async function OpportunitiesPage() {
  ...
  // creation rights regardless of Stripe subscription_tier (mirrors the
  // introductions-page pattern; honors founding_member_expires_at).
  ...
  return (
    <div className="mx-auto max-w-content-narrow px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
