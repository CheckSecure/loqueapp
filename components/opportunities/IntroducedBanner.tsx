...
export function IntroducedBanner({
  ...
  return (
    <div className="mb-6 flex items-center justify-between gap-4 rounded-xl border border-emerald-200/80 bg-emerald-50 px-5 py-4">
      ...
      <div className="flex items-center gap-3">
        <Link
          ...
          className="rounded-lg bg-brand-navy px-4 py-2 text-xs font-medium text-white hover:bg-brand-navy/90 transition-colors"
        >
          Open conversation
        </Link>
        <button
